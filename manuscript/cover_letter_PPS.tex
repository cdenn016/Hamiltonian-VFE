...
This manuscript addresses a longstanding puzzle: why do phenomenological spring-mass models of belief change work so well empirically, despite lacking theoretical justification? Researchers from Kaplowitz and Fink's attitude oscillation studies to modern opinion dynamics have successfully modeled beliefs as objects with mass and momentum---but no one has explained \textit{why} beliefs should behave this way.

I show that belief inertia emerges naturally from variational free energy minimization on statistical manifolds. The Fisher information metric, which measures statistical distinguishability, simultaneously provides an inertial mass tensor for belief dynamics. This single insight unifies several documented but theoretically orphaned phenomena:
